...
import { GeneratePresignedUrlDto, GeneratePresignedUrlResponseDto } from './dto/create-s3.dto';
...
export class S3Controller {
  ...
  create(@Body() generatePresignedUrlDto: GeneratePresignedUrlDto): Promise<GeneratePresignedUrlResponseDto> {
